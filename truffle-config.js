...
module.exports = {
  ...
  networks: {
    ...
    mainnet: {
      provider: () => new HDWalletProvider(process.env.MNEMONIC_PHRASE_MAINNET, process.env.MAINNET_JSON_RPC),
      network_id: 1,       // Ropsten's id
      gas: 5e6,        // Ropsten has a lower block limit than mainnet
      gasPrice: 95e9, // e9 is gwei
